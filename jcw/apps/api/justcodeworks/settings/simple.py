...
SECRET_KEY = env('DJANGO_SECRET_KEY', default='django-insecure-dev-key-12345-change-me')
...
# Simple app configuration (no tenancy for now)
INSTALLED_APPS = [
...
ROOT_URLCONF = 'justcodeworks.urls_simple'
